...
class _ConfigurableExpansionTileState extends State<ConfigurableExpansionTile>
  ...
  late final AnimationController _controller = AnimationController(
    duration: widget.kExpand,
    vsync: this,
  );

  late Animation<double> _iconTurns = _controller.drive(
  ...
  late Animation<double> _heightFactor =
      _controller.drive(ConfigurableExpansionTile._easeInTween);

  late Animation<Color?> _borderColor = _controller.drive(
      _borderColorTween.chain(widget.borderAnimationTween ??
          ConfigurableExpansionTile._easeOutTween));
  late Animation<Color?> _headerColor = _controller.drive(
      _headerColorTween.chain(widget.headerAnimationTween ??
          ConfigurableExpansionTile._easeInTween));
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    final Color headerColor = _headerColor.value ?? Colors.transparent;

    return Container(
      decoration: BoxDecoration(
          border: Border(
        top: BorderSide(
            // widget.topBorderOn as Color ? borderSideColor : Colors.transparent
            color: widget.topBorderOn ?? false
                ? borderSideColor
                : Colors.transparent),
        bottom: BorderSide(
            color: widget.bottomBorderOn ?? false
                ? borderSideColor
                : Colors.transparent),
      )),
      child: Column(
